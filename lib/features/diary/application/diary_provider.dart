...
final diaryBoxProvider = Provider<Box<DiaryEntry>>((ref) {
  // 기본 동작: main.dart에서 명시적으로 override 하는 것이 권장됩니다.
  // 그러나 개발 편의를 위해 Hive 박스가 이미 열려 있으면 해당 박스를 반환합니다.
...
class DiaryListNotifier extends StateNotifier<List<DiaryEntry>> {
  ...
  /// Convenience: find an entry by id or null
  ...
  /// Remove entry by id (synchronous wrapper over deleteDiary)
